...
final class ScannerViewController: UIViewController {
    ...
    lazy private var autoScanButton: UIBarButtonItem = {
        let title = Bundle.localizedString(aClass: ScannerViewController.self, key: "wescan.scanning.auto", value: "Auto") //NSLocalizedString("wescan.scanning.auto", tableName: "Localizable", bundle: Bundle(for: ScannerViewController.self), value: "Auto", comment: "The auto button state")
    ...
    @objc private func toggleAutoScan() {
        if CaptureSession.current.isAutoScanEnabled {
            ...
            autoScanButton.title =  Bundle.localizedString(aClass: ScannerViewController.self, key: "wescan.scanning.manual", value: "Manual")//NSLocalizedString("wescan.scanning.manual", tableName: "Localizable", bundle: Bundle(for: ScannerViewController.self), value: "Manual", comment: "The manual button state")
        } else {
            CaptureSession.current.isAutoScanEnabled = true
            autoScanButton.title = Bundle.localizedString(aClass: ScannerViewController.self, key: "wescan.scanning.auto", value: "Auto")//NSLocalizedString("wescan.scanning.auto", tableName: "Localizable", bundle: Bundle(for: ScannerViewController.self), value: "Auto", comment: "The auto button state")
        }
    }
