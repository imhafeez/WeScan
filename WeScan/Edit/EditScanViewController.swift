...
final class EditScanViewController: UIViewController {
    ...
    lazy private var nextButton: UIBarButtonItem = {
        let title =  Bundle.localizedString(aClass: EditScanViewController.self, key: "wescan.edit.button.next", value: "Next")//NSLocalizedString("wescan.edit.button.next", tableName: "Localizable", bundle: Bundle(for: EditScanViewController.self), value: "Next", comment: "A generic next button")
    ...
    override func viewDidLoad() {
        ...
        setupViews()
        setupConstraints()
        title = Bundle.localizedString(aClass: EditScanViewController.self, key: "wescan.edit.title", value: "Edit Scan") //NSLocalizedString("wescan.edit.title", tableName: "Localizable", bundle: Bundle(for: EditScanViewController.self), value: "Edit Scan", comment: "The title of the EditScanViewController")
